...
class StudentSignupApp(ctk.CTk):
    def __init__(self):
        ...
        # Row 0: Student ID (Left) and Name (Right)
        self.student_id = Form(self.form_frame, text="Student ID:", max_length=50) 
        self.student_id.grid(row=0, column=0, padx=30, pady=15, sticky="w")
        ...
        self.department_combo = ctk.CTkComboBox(self.form_frame, 
                                            values=["Computer Science and Engineering(CSE)", "Electronics and Communication Engineering(ECE)", "Artificial Intelligence and Data Science(AI&DS)", "Mechanical Engineering(ME)"],
                                            dropdown_fg_color="white",
                                            dropdown_text_color="black", 
                                            border_color=colors().purple,
                                            button_color=colors().purple,
        ...
        self.enrollment_year = Form(self.form_frame, text="Enrollment Year:", max_length=50)
        self.enrollment_year.grid(row=3, column=1, padx=30, pady=15, sticky="w")
    ...
    def submit_form(self):
        ...
        data = {
            "Student ID": self.student_id.get_entry().get(),
            ...
            "Enrollment Year": self.enrollment_year.get_entry().get(),
            "Password": self.password.get_entry().get(),
            "Confirm Password": self.confirm_password.get_entry().get()
        }
        
        unfilled_combo_defaults = ["Select Department", "Select Gender"] 
        ...
        for key, value in data.items():
            ...
            elif key in ["Department", "Gender"] and value in unfilled_combo_defaults:
                missing_fields.append(key)
