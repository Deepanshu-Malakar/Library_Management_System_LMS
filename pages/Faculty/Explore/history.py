...
# Showing Book Functions..........................
    ...
    def get_all_books(self):
        books = reissue_book_logic.get_all_issued_books_of_user(self.faculty_record["faculty id"])
        # print(books)
        title_list = []
        author_list = []
        edition_list = []
...
# Search Book by Category Functions..........................
    ...
    def get_books_by_category(self,category):
        ...
        books_data = reissue_book_logic.get_books_by_category(category,self.faculty_record["faculty id"])
        title_list = []
        author_list = []
        edition_list = []
        description_list = []
...
# Search Book by Title or author Functions..........................
    ...
    def get_books_by_title_or_author(self,search_text):
        ...
        # books_data = mysql_tables.cur.fetchall()
        books_data = reissue_book_logic.get_books_by_search(search_text,self.faculty_record["faculty id"])
        title_list = []
        author_list = []
        edition_list = []
        description_list = []
