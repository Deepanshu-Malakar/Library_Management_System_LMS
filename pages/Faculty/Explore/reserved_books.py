...
class ReservedBooksPage:
    def __init__(self,master,faculty_record):
        ...
        self.faculty_id = self.faculty_record["faculty id"]
        self.master = master
...
# Showing Book Functions..........................
    ...
    def get_all_books(self):
        books = reserve_book_logic.get_all_reserved_books(self.faculty_id)
        # print(books)
        title_list = []
        author_list = []
        edition_list = []
...
# Search Book by Category Functions..........................
    ...
    def get_books_by_category(self,category):
        res_books = reserve_book_logic.get_all_reserved_books(self.faculty_id)
        books_data = []
