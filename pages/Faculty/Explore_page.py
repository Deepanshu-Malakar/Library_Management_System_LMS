...
from pages.Faculty.Explore import Explore_sidebar

from pages.Faculty.Explore import home
from pages.Faculty.Explore import history
from pages.Faculty.Explore import favourites
from pages.Faculty.Explore import reserved_books
from pages.Faculty.Explore import study_section
...
class Page:
    def __init__(self,master,sidebar_control:Explore_sidebar.Sidebar_control,faculty_record):
        ...
        self.page_frame = home.HomePage(self.frame,self.faculty_record)
    ...
    def open_favourites_page(self,e):
        self.page_frame.pack_forget()
        self.page_frame = favourites.FavouritesPage(self.frame,self.faculty_record)
        self.page_frame.pack()
        self.current_tab = "Favourites"

    def open_history_page(self,e):
        self.page_frame.pack_forget()
        self.page_frame = history.HistoryPage(self.frame,self.faculty_record)
        self.page_frame.pack()
        self.current_tab = "History"

    def open_study_section_page(self,e):
        self.page_frame.pack_forget()
        self.page_frame = study_section.StudySectionPage(self.frame,self.faculty_record)
        self.page_frame.pack()
        self.current_tab = "Study section"

    def open_reserved_books_page(self,e):
        self.page_frame.pack_forget()
        self.page_frame = reserved_books.ReservedBooksPage(self.frame,self.faculty_record)
        self.page_frame.pack()
