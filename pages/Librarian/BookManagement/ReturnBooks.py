...
from components import return_book_icon
...
# Showing Book Functions..........................
    ...
    def get_all_books(self):
        books = issue_books_logic.get_all_issued_books()
        # print(books)
        title_list = []
        author_list = []
        edition_list = []
        ...
        for i in range (len(title_list)):
            ...
            book = return_book_icon.Book_icon(self.books_frame,
...
# Search Book by Category Functions..........................
    ...
    def get_books_by_category(self,category):
        ...
        books_data = issue_books_logic.get_issued_books_by_category(category)
        title_list = []
        author_list = []
        edition_list = []
        description_list = []
...
# Search Book by Title or author Functions..........................
    ...
    def get_books_by_title_or_author(self,search_text):
        ...
        # books_data = mysql_tables.cur.fetchall()
        books_data = issue_books_logic.search_issued_books(search_text)
        title_list = []
        author_list = []
        edition_list = []
        description_list = []
