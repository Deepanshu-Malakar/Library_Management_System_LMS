...
from components import reserve_book_icon
...
# Showing Book Functions..........................
    ...
    def get_all_books(self):
        books = reserve_to_issue_logic.get_all_reserved_books()
        # print(books)
        title_list = []
        author_list = []
        edition_list = []
        ...
        for book in books:
            ...
            reserver_id_list.append(book[6])
        books = []
        for i in range (len(title_list)):
            ...
            book = reserve_book_icon.Book_icon(self.books_frame,
                                       logo=cover_img_list[i],
                                       book_name=title_list[i],
                                       author=author_list[i],
                                       edition=edition_list[i],
                                       copies_available=copies_available,
                                       reserver_id=reserver_id_list[i])
...
# Search Book by Category Functions..........................
    ...
    def get_books_by_category(self,category):
        ...
        books_data = reserve_to_issue_logic.get_books_by_category(category)
        title_list = []
        author_list = []
        edition_list = []
        description_list = []
...
# Search Book by Title or author Functions..........................
    ...
    def get_books_by_title_or_author(self,search_text):
        ...
        # books_data = mysql_tables.cur.fetchall()
        books_data = reserve_to_issue_logic.get_books_by_title_author_reserver(search_text)
        title_list = []
        author_list = []
        edition_list = []
        description_list = []
