...
from components import requested_book_icon
...
# Showing Book Functions..........................
    ...
    def get_all_books(self):
        books = request_books_logic.get_all_requested_books()
        # print(books)
        title_list = []
        author_list = []
        edition_list = []
        ...
        for book in books:
            ...
            total_requests_list.append(book[6])
        books = []
        for i in range (len(title_list)):
            ...
            book = requested_book_icon.Book_icon(self.books_frame,
                                       logo=cover_img_list[i],
                                       book_name=title_list[i],
                                       author=author_list[i],
                                       edition=edition_list[i],
                                       total_requests=total_requests_list[i])
...
# Search Book by Category Functions..........................
    ...
    def get_books_by_category(self,category):
        ...
        books_data = request_books_logic.get_book_by_category(category)
        title_list = []
        author_list = []
        edition_list = []
        description_list = []
        ...
        for book in books_data:
            ...
            description_list.append(book[5])
            cover_img_list.append(book[4])
            total_request_list.append(book[6])
        books = []
        for i in range (len(title_list)):
            title = title_list[i]
            ...
            book = requested_book_icon.Book_icon(self.books_frame,
                                       ...
                                       author=author_list[i],
                                       edition=edition_list[i],
                                       total_requests=total_request_list[i])
            book.description(description_list[i])
            books.append(book)
        return books
# / Search Book by Category Functions......................
...
# Search Book by Title or author Functions..........................
    ...
    def get_books_by_title_or_author(self,search_text):
        ...
        # books_data = mysql_tables.cur.fetchall()
        books_data = request_books_logic.get_books_by_title_or_author(search_text)
        title_list = []
        author_list = []
        edition_list = []
        description_list = []
