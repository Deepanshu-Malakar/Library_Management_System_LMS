...
from components import issue_book_icon
from components import search_bar
from components import category_folders
from components import colors

class IssuePage:
    def __init__(self,master,librarian_record = None):
        self.librarian_record = librarian_record
        self.master = master
...
# Showing Book Functions..........................
    ...
    def get_all_books(self):
        ...
        for i in range (len(title_list)):
            ...
            book = issue_book_icon.Book_icon(self.books_frame,
