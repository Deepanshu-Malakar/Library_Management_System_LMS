...
from backend import due_books_logic
from components import approve_due_book_icon
...
# Showing Book Functions..........................
    ...
    def get_all_books(self):
        books = due_books_logic.get_all_due_books()
        # print(books)
        title_list = []
        author_list = []
        edition_list = []
        ...
        for book in books:
            ...
            borrower_list.append(book[6])
            issue_date_list.append(book[7])
            return_date_list.append(book[8])
        books = []
        for i in range (len(title_list)):
            ...
            book = approve_due_book_icon.Book_icon(self.books_frame,
                                       logo=cover_img_list[i],
                                       book_name=title_list[i],
                                       author=author_list[i],
                                       edition=edition_list[i],
                                       borrower_id=borrower_list[i],
...
# Search Book by Category Functions..........................
    ...
    def get_books_by_category(self,category):
        ...
        books_data = due_books_logic.get_books_by_category(category)
        title_list = []
        author_list = []
        edition_list = []
        description_list = []
...
# Search Book by Title or author Functions..........................
    ...
    def get_books_by_title_or_author(self,search_text):
        ...
        # books_data = mysql_tables.cur.fetchall()
        books_data = due_books_logic.get_books_by_search_text(search_text)
        title_list = []
        author_list = []
        edition_list = []
        description_list = []
