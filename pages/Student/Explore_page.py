...
from pages.Student.Explore import home
from pages.Student.Explore import history
from pages.Student.Explore import favourites
from pages.Student.Explore import reserved_books
from pages.Student.Explore import study_section


class Page:
    def __init__(self,master,sidebar_control:Explore_sidebar.Sidebar_control,student_record):
        ...
        self.page_frame = home.HomePage(self.frame,student_record)
    ...
    def open_home_page(self,e):
        ...
        self.page_frame = home.HomePage(self.frame,self.student_record)
        self.page_frame.pack()
        self.current_tab = "Home"

    def open_favourites_page(self,e):
        self.page_frame.pack_forget()
        self.page_frame = favourites.FavouritesPage(self.frame,self.student_record)
        self.page_frame.pack()
        self.current_tab = "Favourites"

    def open_history_page(self,e):
        self.page_frame.pack_forget()
        self.page_frame = history.HistoryPage(self.frame,self.student_record)
        self.page_frame.pack()
        self.current_tab = "History"

    def open_study_section_page(self,e):
        self.page_frame.pack_forget()
        self.page_frame = study_section.StudySectionPage(self.frame,self.student_record)
        self.page_frame.pack()
        self.current_tab = "Study section"

    def open_reserved_books_page(self,e):
        self.page_frame.pack_forget()
        self.page_frame = reserved_books.ReservedBooksPage(self.frame,self.student_record)
        self.page_frame.pack()
