...
from pages.Student import Doubt_section_page
from pages.Student import Book_center_page
from pages.Student import Help_and_support_page
...
class Student_Dashboard:
    ...
    def create_dashboard(self):
        ...
        self.page_frame = Explore_page.Page(self.frame,self.sidebar_control,self.student_record)
    ...
    # Hi username , library logo and sidebar controller
        ...
        self.sidebar_control = sidebar_control_button.Sidebar_control(self.upper_frame,f"Hii {self.username}")
    ...
    def create_status_bar(self):
        reserved_books = status_bar_logic.reserved_books(self.student_record["student id"])
        issued_books = status_bar_logic.issued_books(self.student_record["student id"])
        due_books = status_bar_logic.due_books(self.student_record["student id"])
        fine = status_bar_logic.pending_fine(self.student_record["student id"])
...
# tabs opening functions.................
    ...
    def open_bookcenter_tab(self,e):
        ...
        self.page_frame.pack_forget()
        self.page_frame = Book_center_page.Page(self.frame,self.sidebar_control,self.student_record)
        self.page_frame.pack()
    ...
    def open_doubt_section_tab(self,e):
        ...
        self.page_frame.pack_forget()
        self.page_frame = Doubt_section_page.Page(self.frame,self.sidebar_control,self.student_record)
        self.page_frame.pack()
    ...
    def open_help_tab(self,e):
        ...
        self.Help_tab.click()
        self.page_frame.pack_forget()        
        self.page_frame = Help_and_support_page.Page(self.frame,self.sidebar_control,self.student_record)
        self.page_frame.pack()
...
if __name__ == "__main__":
    ...
    page = Student_Dashboard(root,"Ankit")
    page.pack()
