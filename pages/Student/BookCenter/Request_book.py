...
class RequestBookPage:
    def __init__(self,master,student_record):
        ...
        self.student_id = self.student_record["student id"]
        self.master = master
    ...
    def add_book(self):
        ...
        if title=="" or author=="" or edition==""  or category=="":
            ...
            for i in range(int(1)):
                request_books_logic.insert_request(self.student_id,title,author,edition,category,cover_img,description)
            messagebox.showinfo("Success","Book Requested Successfully, Thanks for your suggestion")
            self.clear_fields()
