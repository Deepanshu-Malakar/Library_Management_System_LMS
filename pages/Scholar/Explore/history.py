...
from components import reissue_book_icon
...
class HistoryPage:
    def __init__(self,master,scholar_record):
        ...
        self.scholar_id = self.scholar_record["scholar id"]
        self.master = master
...
# Showing Book Functions..........................
    ...
    def get_all_books(self):
        books = reissue_book_logic.get_all_issued_books_of_user(self.scholar_id)
        # print(books)
        title_list = []
        author_list = []
        edition_list = []
        ...
        for book in books:
            ...
            issue_date_list.append(book[6])
            return_date_list.append(book[7])
            status_list.append(book[8])
        books = []
        for i in range (len(title_list)):
            ...
            book = reissue_book_icon.Book_icon(self.books_frame,
                                       logo=cover_img_list[i],
                                       book_name=title_list[i],
                                       author=author_list[i],
                                       edition=edition_list[i],
                                       user=self.scholar_id,
                                       issue_date=issue_date_list[i],
                                       expiry_date=return_date_list[i],
...
# Search Book by Category Functions..........................
    ...
    def get_books_by_category(self,category):
        ...
        books_data = reissue_book_logic.get_books_by_category(category,self.scholar_id)
        title_list = []
        author_list = []
        edition_list = []
        description_list = []
...
# Search Book by Title or author Functions..........................
    ...
    def get_books_by_title_or_author(self,search_text):
        ...
        # books_data = mysql_tables.cur.fetchall()
        books_data = reissue_book_logic.get_books_by_search(search_text,self.scholar_id)
        title_list = []
        author_list = []
        edition_list = []
        description_list = []
