...
# Showing Book Functions..........................
    ...
    def get_all_books(self):
        books = reserve_book_logic.get_all_reserved_books(self.scholar_id)
        # print(books)
        title_list = []
        author_list = []
        edition_list = []
...
# Search Book by Category Functions..........................
    ...
    def get_books_by_category(self,category):
        res_books = reserve_book_logic.get_all_reserved_books(self.scholar_id)
        books_data = []
        for res_book in res_books:
            if res_book[3] == category:
                books_data.append(res_book)
...
# Search Book by Title or author Functions..........................
    ...
    def get_books_by_title_or_author(self,search_text):
        ...
        query = f"select b.title,b.author,b.edition from reserve_books r, books b where b.book_id = r.book_id and user_id = '{user_id}' and (b.title like '%{search_text}%' or b.author like '%{search_text}%')"
        mysql_tables.cur.execute(query)
