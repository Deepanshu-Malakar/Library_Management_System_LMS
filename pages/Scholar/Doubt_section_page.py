...
from pages.Scholar.Doubt import sidebar

from pages.Scholar.Doubt import All_doubts
from pages.Scholar.Doubt import Ask_doubt
from pages.Scholar.Doubt import Leaderboard
from pages.Scholar.Doubt import My_doubts
from pages.Scholar.Doubt import Solved_by_me
...
class Page:
    def __init__(self,master,sidebar_control:sidebar.Sidebar_control,scholar_record):
        ...
        self.page_frame = All_doubts.AllDoubtsPage(self.frame,self.scholar_record)
    ...
    def open_my_doubts_page(self,e):
        self.page_frame.pack_forget()
        self.page_frame = My_doubts.MyDoubtsPage(self.frame,self.scholar_record)
        self.page_frame.pack()
        self.current_tab = "My Doubts"

    def open_solved_by_me_page(self,e):
        self.page_frame.pack_forget()
        self.page_frame = Solved_by_me.SolvedByMePage(self.frame,self.scholar_record)
        self.page_frame.pack()
        self.current_tab = "Solved by me"

    def open_ask_doubt_page(self,e):
        self.page_frame.pack_forget()
        self.page_frame = Ask_doubt.AskDoubtPage(self.frame,self.scholar_record)
        self.page_frame.pack()
        self.current_tab = "Ask Doubt"

    def open_leaderboard_page(self,e):
        self.page_frame.pack_forget()
        self.page_frame = Leaderboard.LeaderboardPage(self.frame,self.scholar_record)
        self.page_frame.pack()
