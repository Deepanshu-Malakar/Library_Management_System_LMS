...
class Book_icon:
    ...
    def create_book(self):
        ...
        self.expiry_date_label = CTkLabel(self.frame,text=f"Expired On : {self.expiry_date}",font=("roboto",12))
        ...
        self.return_btn_img = CTkImage(Image.open("resources/icons/reissued.png"),size=(17,17))
...
# Click Functions........
    ...
    def return_btn_click(self):
        due_books_logic.approve_due_book(self.borrower_id,self.title,self.author,self.edition)
