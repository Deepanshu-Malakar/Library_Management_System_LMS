...
from backend import reserve_to_issue_logic
...
class Book_icon:
    def __init__(self,master:CTkFrame,logo:str,book_name:str,author:str,edition:int,copies_available,reserver_id):#,user:str):
        self.master = master
    ...
    def create_book(self):
        ...
        self.borrower_id_label = CTkLabel(self.frame,text=f"Reserver Id : {self.reserver_id}",font=("roboto",12))
        self.borrower_id_label.place(x=200,y=180)


        self.issue_btn = CTkButton(self.frame,
                                       text="                Issue Book",
                                       font=("roboto",12,"bold"),
                                       width=180,
                                       height=40,
                                       ...
                                       anchor="w",
                                       command=self.issue_btn_click)
        
  
        self.issue_btn_img = CTkImage(Image.open("resources/icons/issue book light.png"),size=(17,17))

        self.issue_btn_img_label = CTkLabel(self.frame,image=self.issue_btn_img,text="",fg_color=colors.new_button_color,bg_color=colors.new_button_color)

        self.issue_btn_img_label.place(x=200,y=225)

        self.issue_btn.place(x=180,y=220)

        #hover effects.................................
        self.issue_btn.bind("<Enter>",self.favourite_btn_hover)
        self.issue_btn.bind("<Leave>",self.favourite_btn_unhover)
        ...
        self.issue_btn.bind("<Enter>",self.frame_hover)
        self.issue_btn.bind("<Leave>",self.frame_unhover)
...
#Hover effects funtions...
    ...
    def favourite_btn_hover(self,event):
        self.issue_btn_img_label.configure(fg_color = colors.new_button_color_hover,bg_color = colors.new_button_color_hover)

    def favourite_btn_unhover(self,event):
        self.issue_btn_img_label.configure(fg_color = colors.new_button_color,bg_color = colors.new_button_color)
...
# Click Functions........
    ...
    def issue_btn_click(self):
        if reserve_to_issue_logic.issue_book(self.reserver_id,self.title,self.author,self.edition):
